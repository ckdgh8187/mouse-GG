...
class Game {
    constructor() {
        ...
        // Sound Effects
        this.sounds = {
            block_drop: new Audio('asset/sound/block_drop.ogg'),
            block_clear: new Audio('asset/sound/block_clear.ogg'),
            coin: new Audio('asset/sound/coin.wav'),
            buy: new Audio('asset/sound/buy.wav'),
            game_over: new Audio('asset/sound/game_over.wav'),
            item1: new Audio('asset/sound/item1.wav'), // Bomb
            item2: new Audio('asset/sound/item2.wav'), // Laser
            item3: new Audio('asset/sound/item3.wav')  // Hourglass
        };
    ...
    playSound(name) {
        if (this.sounds[name]) {
            ...
            this.sounds[name].play().catch(() => { }); // catch ignore auto-play policy errors
        }
    }
